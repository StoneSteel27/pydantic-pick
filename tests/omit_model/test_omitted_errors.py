...
def test_omitted_attributes_raise_custom_error():
    ...
    PublicItem = omit_model(InvoiceItem, ("tax_rate",), "PublicItem")
...
def test_kept_attributes_work_normally():
    ...
    """
    # This time, we keep all required dependencies (omit nothing that breaks things)
    FullItem = omit_model(InvoiceItem, (), "FullItem")
...
def test_omitted_wrapped_methods_raise_custom_error():
    ...
    PublicSecured = omit_model(SecuredItem, ("secret_code",), "PublicSecured")
...
def test_kept_wrapped_methods_work_normally():
    ...
    """
    # We keep everything
    FullSecured = omit_model(SecuredItem, (), "FullSecured")
